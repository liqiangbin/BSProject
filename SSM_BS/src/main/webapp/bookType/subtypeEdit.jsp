				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><a href="javascript:void(0);"
							...
							>图书分类管理</a> <i
							class="fa fa-angle-right"></i></li>
						<li class="active"><a href="javascript:void(0);">编辑细类</a></li>
					</ul>
				</div>
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-stumbleupon-circle font-green-sharp"></i> <span
										class="caption-subject font-green-sharp bold">编辑图书细类</span>
								</div>
							...
							<div class="portlet-body">
								<div class="table-responsive">
									<form class="form-horizontal form-row-seperated form-inline"
										action="<%=request.getContextPath() %>/subType/updateSubtype" method="post" id="createNotice"
										enctype="multipart/form-data">
										<!-- <input type="hidden" name="genType" value=""/> -->
										<table class="table table-bordered table_sxcondition ">
											<tbody>
											<input type="hidden" id="id" name="id" value=${subtype.id }>
											<tr>
													...
													<select id="typenumber"
														...
														required="required">
															<c:forEach var="type" items="${typeList}" > 
																	 <option value="${type.typenumber}" <c:if test="${type.typenumber==subtype.typenumber}">selected</c:if>>${type.typedescn}</option>
															</c:forEach>
													</select>
													</td>
												</tr>
												...
												<tr>
													...
													<td class="lineheight34"><textarea rows="10" cols="8"
															...
															value="">${subtype.subtypedescn }</textarea></td>
												</tr>
												<tr>
													<th></th>
													<td>
