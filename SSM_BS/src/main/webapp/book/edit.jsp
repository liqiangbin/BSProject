					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><a href="javascript:void(0);">图书管理</a> <i
								class="fa fa-angle-right"></i></li>
							<li class="active"><a href="javascript:void(0);">新书信息修改</a></li>
							...
							<div class="portlet light">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-stumbleupon-circle font-green-sharp"></i> <span
											class="caption-subject font-green-sharp bold">图书信息修改 <!-- 现 金 券 详 情--></span>
									</div>
								...
								<div class="portlet-body">
									<div class="table-responsive">
										<form action='<c:url value="/book/bookUpdate"></c:url>'
												...
												<tbody>
													...
													<tr>
														...
														<td width="75%" class="lineheight34"><input
															...
															class="form-control input-large" value="${book.name }">
														</td>
													</tr>
													<tr>
														<th width="25%">作者：</th>
														<td width="75%" class="lineheight34"><input
															...
															class="form-control input-large" value="${book.author}">
														</td>
													</tr>
													...
													<tr>
														...
														<td width="75%" class="lineheight34" style="color: blue;">
															...
															class="form-control input-large" value="${book.publish }">
														</td>
													</tr>
													<tr>
														<th width="25%">售价：</th>
														<td width="75%" class="lineheight34">
															<div class="form-inline">
																<input type="text" id="price" name="price"
																	class="form-control input-large" value="${book.price }">
																...
																<select class="form-control input-large"
																	...
																	<c:forEach var="type" items="${typeList}">
																		<option value="${type.typenumber}"
																			<c:if test="${book.type==type.typenumber}">selected</c:if>>${type.typedescn}</option>
																	</c:forEach>
																</select> <select class="form-control input-large"
																	data-placeholder="全部" id="subtype" name="subtype">
																	<c:forEach var="sub" items="${subList}">
																		<c:if test="${book.type==sub.typenumber}">
																			<option value="${sub.id}"
																				<c:if test="${book.subtype==sub.id}">selected</c:if>>${sub.subtypedescn}</option>
																		</c:if>
																	</c:forEach>
																</select>
															</div>
														...
														<td width="75%" class="lineheight34">
															<div class="form-inline">
																<input type="text" id="stock" name="stock"
																	class="form-control input-large" value="${book.stock }">&nbsp;
													...
													<tr>
														...
														<td width="75%" class="lineheight34"><textarea
																...
																value="">${book.introduce}</textarea></td>
													</tr>
													<tr>
														<th width="25%">封面图片：</th>
														<td>
