	...
	<%@ include file="/customer/commons/top.jsp"%>
		...
		<div class="register">
			<div class="container">
				...
				<div class="alert alert-danger" id="warning">${regeistMessage}</div>
					<h5 class="animated wow slideInUp" data-wow-delay=".5s" style="font-family: 微软雅黑;">兴趣调查(请至少选择一项方便为您推荐)</h5>
					<form class="animated wow slideInUp" id="regeistForm" data-wow-delay=".5s" action='<c:url value="/customer/regeist"></c:url>' method="post">
					...
					<h6 class="animated wow slideInUp" data-wow-delay=".5s" style="font-family: '微软雅黑';">登录信息</h6>
						...
						<input type="hidden" id="status" name="status" value="${regeistMessage }" >
