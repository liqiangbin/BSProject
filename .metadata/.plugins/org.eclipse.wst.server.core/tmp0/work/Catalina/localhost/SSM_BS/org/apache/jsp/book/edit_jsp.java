 ...
 * Generated at: 2016-06-03 10:02:14 UTC
...
static {
  ...
  static {
    ...
    _jspx_dependants.put("/commons/top.jsp", Long.valueOf(1464763365979L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"sessionIsTrue\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${managerLoginname}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      ...
      out.write("\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\tvar sessions=$(\"#sessionIsTrue\").val();\r\n");
      out.write("\t\t\tif(sessions==\"\"||sessions==null){\r\n");
      ...
      out.write("\t\t\t\t<div class=\"page-content\" style=\"min-height: 801px\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<li><i class=\"fa fa-home\"></i> <a href=\"#\"> IBooK首页 </a> <i\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"fa fa-angle-right\"></i></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"javascript:void(0);\">图书管理</a> <i\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"fa fa-angle-right\"></i></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"active\"><a href=\"javascript:void(0);\">新书信息修改</a></li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-stumbleupon-circle font-green-sharp\"></i> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"caption-subject font-green-sharp bold\">图书信息修改 <!-- 现 金 券 详 情--></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"actions btn-set\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-default btn-circle\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\thref=\"javascript:void(0);\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"javascript:history.go(-1)\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-angle-left\"></i> 返回<!-- 返 回--></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      if (_jspx_meth_c_005furl_005f72(_jspx_page_context))
        return;
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tmethod=\"post\" id=\"addBookForm\">\r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">图书名称：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" id=\"name\" name=\"name\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control input-large\" value=\"");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">出版社：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\" style=\"color: blue;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"publish\" name=\"publish\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control input-large\" value=\"");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tpl-fr\" style=\"color: blue;\">元</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">折扣：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: red; font-stretch: wider;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"discount\" name=\"discount\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control input-large\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: blue;\">折<label\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: grey;\">(必须是大于0小于等于1的数字)</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">图书类别<!-- 客 服 电 话-->：\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control input-large\"\r\n");
      ...
      if (_jspx_meth_c_005fforEach_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select> <select class=\"form-control input-large\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">库存 <!-- 客 服 电 话-->：\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"stock\" name=\"stock\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control input-large\" value=\"");
      ...
      out.write("\">&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"tpl-fr\">本</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">图书简介：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\"><textarea\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trows=\"10\" cols=\"8\" id=\"introduce\" name=\"introduce\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control form-control250 required validate-alphanum\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"max-width: 600px; width: 98%; height: 120px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"\">");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">封面图片：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"uploadFile_1\" name=\"uploadFile_1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"选择文件\" disabled=\"disabled\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" style=\"margin-top: -10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"clickUpload('mainimgFile')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"mainimg\" name=\"mainimg\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.mainimg}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"mainimgFile\" name=\"mainimgFile\" value=\"上传图片\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"set-up-button upload\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; width: 200px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonchange=\"onUploadImgChange(this,500,'mainImgShow')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-url=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmultiple>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label id=\"pic_label1\" style=\"color: red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- <input type=\"hidden\" id=\"mallimage\" name=\"mallimage\" value=\"\"> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"border-bottom\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding: 0; width: 50%;\"><img\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"mainImgShow\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"shlogo pull-left margin-right10\" src='");
      if (_jspx_meth_c_005furl_005f74(_jspx_page_context))
        return;
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 200px; height: 160px;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"previewInfo\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>图片建议尺寸：320像素x240像素</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>仅支持.jpg .jpeg .bmp .png格式</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>长方形照片，大小不超过200K</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" style=\"margin-top: -10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"clickUpload('img1File')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"img1\" name=\"img1\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.img1}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"img1File\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"img1File\" value=\"上传图片\" class=\"set-up-button upload\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; width: 200px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonchange=\"onUploadImgChange(this,500,'img1Show')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-url=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmultiple>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label id=\"img1Info\" style=\"color: red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- <input type=\"hidden\" id=\"mallimage\" name=\"mallimage\" value=\"\"> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding: 0; width: 50%;\"><img\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"img1Show\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"shlogo pull-left margin-right10\" src='");
      if (_jspx_meth_c_005furl_005f76(_jspx_page_context))
        return;
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 160px; height: 120px;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"previewInfo\"></span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>图片建议尺寸：320像素x240像素</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>仅支持.jpg .jpeg .bmp .png格式</p>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<!--这是复制介绍图片  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr id=\"inputcopy\" style=\"display: none;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" style=\"margin-top: -10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"clickUpload('img2File')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"img2\" name=\"img2\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.img2 }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <input type=\"file\" id=\"img2File\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"img2File\" value=\"上传图片\" class=\"set-up-button upload\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; width: 200px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonchange=\"onUploadImgChange(this,500,'img2Show')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-url=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmultiple>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label id=\"img2Info\" style=\"color: red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style=\"margin-left: 50px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn default btn-sm\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"deleteImg()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr id=\"imgcopy\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"border-bottom\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr id=\"imgaddbutton\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"addImg()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary btn-sm\" id=\"addalbums_btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i>添加图片\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button> <span class=\"info notice\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-info-circle\"></i> 最多可以上传2张图片</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">试读相册<!-- 商 家 相 册-->：\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><span class=\"info notice\" style=\"color: orange;\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-info-circle\"></i>试读图片默认页码默认从第一页开始，请按顺序上传！</span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<!--读取已经存在的试读图片  -->\r\n");
      out.write("                                      ");
      if (_jspx_meth_c_005fforEach_005f2(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr id=\"readFreeAddButton\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"addReadFree()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary btn-sm\" id=\"addalbums_btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i>添加图片\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button> <span class=\"info notice\" style=\"color: green\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"notice\"><i class=\"fa fa-info-circle\"></i> <label\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"freeNumber\">您还可以上传10张图片</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<!-- 下面是试读模板 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr class=\"album_div\" id=\"readFreeModel1\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" style=\"margin-top: -10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"clickUpload('readFreeFile')\" style=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  \t<input type=\"hidden\" id=\"readFreeId\" name=\"readFreeId\" value=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"readFreeNumber\" name=\"readFreeNumber\" value=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"readFreeName\" name=\"readFreeName\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"readFree\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"readFree\" value=\"上传图片\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"set-up-button upload readFree\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; width: 200px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonchange=\"onUploadImgChange1(this,500,'')\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-url=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style=\"margin-left: 50px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn default btn-sm\" type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"deleteReadFree(this,0)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-trash-o\"></i>删除\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix margin-top10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"\" class=\"shlogo pull-left margin-right10\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 160px; height: 120px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"pull-left shlogonotice\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"line-height: 22px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t图 片建议尺寸：320像素x240像素<br> 仅支持 .jpg.jpeg.bmp.png格式<br>长\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t方 形 照 片，大小不超过200KB\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn default\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t\tfunction fileClick() {\r\n");
      out.write("\t\t\t$(\"#mallimagefile\").click();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction clickUpload(id) {\r\n");
      out.write("\t\t\t//console.log(\"click file upload\");\r\n");
      out.write("\t\t\tdocument.getElementById(id).click();\r\n");
      out.write("\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//判断第二张介绍图片是否存在\r\n");
      out.write("\t\tvar img2=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.img2}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\";\r\n");
      out.write("\t\tconsole.log(img2);\r\n");
      out.write("\t\tif(img2!=\"\"&&img2!=null){\r\n");
      out.write("\t\t\taddImg();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//复制介绍图片\r\n");
      out.write("\t\tfunction addImg() {\r\n");
      out.write("\t\t\t$(\"#inputcopy\").show();\r\n");
      out.write("\t\t\t$(\"#imgcopy\").show();\r\n");
      out.write("\t\t\t$(\"#imgaddbutton\").hide();\r\n");
      out.write("\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//复制试读图片\r\n");
      out.write("\t\tvar cloneCount =parseInt(");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:length(readFreeList)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0, false));
      out.write(");\r\n");
      out.write("\t\tvar nowCount=parseInt(10-cloneCount);\r\n");
      out.write("\t\t$(\"#freeNumber\").html(\"您还可以上传\" + nowCount + \"张图片！\");\r\n");
      out.write("\t\tfunction addReadFree() {\r\n");
      out.write("\t\t\tif (cloneCount < 10) {\r\n");
      out.write("\t\t\t\tcloneCount++;\r\n");
      out.write("\t\t\t\tvar xxx = $(\"#readFreeModel1\").clone();\r\n");
      out.write("\t\t\t\t$(\"#readFreeAddButton\").before(xxx);\r\n");
      out.write("\t\t\t\txxx.show();\r\n");
      out.write("\t\t\t\txxx.removeAttr(\"id\");\r\n");
      out.write("\t\t\t\txxx.find(\"input[type='file']\").attr(\"onchange\",\"onUploadImgChange(this, 500, 'clonelogo\" + cloneCount+ \"')\");\r\n");
      out.write("\t\t\t\txxx.find(\"img\").attr(\"id\", \"clonelogo\" + cloneCount);\r\n");
      out.write("\t\t\t\txxx.find(\"input[type='file']\").attr(\"id\",\r\n");
      out.write("\t\t\t\t\t\t\"cloneid\" + cloneCount);\r\n");
      out.write("\t\t\t\txxx.find(\"label\").attr(\"id\", \"clonelabel\" + cloneCount);\r\n");
      out.write("\t\t\t\txxx.find(\"button.fileUpload\").attr(\"onclick\",\r\n");
      out.write("\t\t\t\t\t\t\"clickUpload('cloneid\" + cloneCount + \"');\");\r\n");
      out.write("\t\t\t\treadfreeUpload(\"cloneid\" + cloneCount,\"clonelabel\" + cloneCount);\r\n");
      out.write("\t\t\t\tvar num =10-cloneCount;\r\n");
      out.write("\t\t\t\t$(\"#notice\").attr(\"style\", \"color:green\");\r\n");
      out.write("\t\t\t\t$(\"#freeNumber\").html(\"您还可以上传\" + num + \"张图片！\");\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$(\"#notice\").attr(\"style\", \"color:red;\");\r\n");
      out.write("\t\t\t\t$(\"#freeNumber\").html(\"您可以上传的图片已达上限！\");\r\n");
      out.write("\t\t\t\t$(\"#readFreeAddButton\").hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//删除介绍图片\r\n");
      out.write("\t\tfunction deleteImg() {\r\n");
      out.write("\t\t\t$(\"#inputcopy\").hide();\r\n");
      out.write("\t\t\t$(\"#imgcopy\").hide();\r\n");
      out.write("\t\t\t$(\"#imgaddbutton\").show();\r\n");
      out.write("\t\t\t$(\"#img2\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#img2File\").val(\"\");\r\n");
      out.write("\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction deleteReadFree(_this,id) {\r\n");
      out.write("\t\t\tcloneCount--;\r\n");
      out.write("\t\t\tvar num = 10 - cloneCount;\r\n");
      out.write("\t\t\t$(_this).parents(\"tr\").html(\"\");\r\n");
      out.write("\t\t\t$(_this).parents(\"tr\").remove();\r\n");
      out.write("\t\t\t$(\"#notice\").attr(\"style\", \"color:green\");\r\n");
      out.write("\t\t\t$(\"#freeNumber\").html(\"您还可以上传\" + num + \"张图片！\");\r\n");
      out.write("\t\t\t$(\"#readFreeAddButton\").show();\r\n");
      out.write("\t\t\t//删除试读\r\n");
      out.write("\t\t\tif(id!=0){\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\ttype : \"POST\",\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction onUploadImgChange(sender, size, preview) {\r\n");
      out.write("\t\t\t console.log();\r\n");
      out.write("\t\t\t$(sender).parent().next().attr(\"style\", \"color:red;\");\r\n");
      out.write("\t\t\tif (!sender.value.match(/.jpg|.jpeg|.png|.bmp/i)) {\r\n");
      out.write("\t\t\t\t$(sender).parent().next().html('图 片 格 式 无 效 ！');//<!-- -->\r\n");
      out.write("\t\t\t\tsender.value = null;\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tvar fileSize = sender.files[0].size;\r\n");
      out.write("\t\t\tif (fileSize > 1024 * size) {\r\n");
      out.write("\t\t\t\t$(sender).parent().next().html('文件过大！(建议小于 ' + size + 'k)');\r\n");
      out.write("\t\t\t\tsender.value = null;\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tvar agent = window.navigator.userAgent;\r\n");
      out.write("\t\t\tif (agent.indexOf(\"Firefox\") != -1 || agent.indexOf(\"Chrome\") != -1\r\n");
      out.write("\t\t\t\t\t|| agent.indexOf(\"Mozilla\") != -1) {\r\n");
      out.write("\t\t\t\ttry {\r\n");
      out.write("\t\t\t\t\tif (preview == '') {\r\n");
      out.write("\t\t\t\t\t\t$(sender).parent(\"div\").next(\"img\").css({\r\n");
      out.write("\t\t\t\t\t\t\t\"width\" : \"220px\",\r\n");
      out.write("\t\t\t\t\t\t\t\"height\" : \"160px\"\r\n");
      out.write("\t\t\t\t\t\t}).attr(\"src\",\r\n");
      out.write("\t\t\t\t\t\t\t\twindow.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#\" + preview).attr(\"src\",\r\n");
      out.write("\t\t\t\t\t\t\t\twindow.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t} catch (e) {\r\n");
      out.write("\t\t\t\t\t$(sender).parent().next().html('不是有效图片格式!');//\r\n");
      out.write("\t\t\t\t\tsender.value = null;\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$(\"#\" + preview).next().html('暂不支持预览!');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(sender).parent().next().html('');\r\n");
      out.write("\t\t\tvar arr = $(sender).val().split('\\\\');\r\n");
      out.write("\t\t\t$(sender).parent().prev().val(arr[arr.length - 1]);\r\n");
      out.write("\t\t\t$(sender).prev().val(arr[arr.length - 1]);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//试读相册按钮点击事件$(\"#readFree\").parent().parent().find(\"img\");\r\n");
      out.write("\t\tfunction scanClick(_this) {\r\n");
      out.write("\t\t\t$(_this).next().click();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//试读相册显示上传图片之后显示\r\n");
      out.write("\t\tfunction onUploadImgChange1(sender, size, preview) {\r\n");
      out.write("\t\t\t$(sender).parent().next().attr(\"style\", \"color:red;\");\r\n");
      out.write("\t\t\tif (!sender.value.match(/.jpg|.jpeg|.png|.bmp/i)) {\r\n");
      out.write("\t\t\t\t$(sender).parent().next().html('图 片 格 式 无 效 ！');//<!-- -->\r\n");
      out.write("\t\t\t\tsender.value = null;\r\n");
      ...
      out.write("\t\t\t\ttry {\r\n");
      out.write("\t\t\t\t\tif (preview == '') {\r\n");
      out.write("\t\t\t\t\t\t$(sender).parent().parent().find(\"img\").css({\r\n");
      out.write("\t\t\t\t\t\t\t\"width\" : \"220px\",\r\n");
      out.write("\t\t\t\t\t\t\t\"height\" : \"160px\"\r\n");
      out.write("\t\t\t\t\t\t}).attr(\"src\",\r\n");
      out.write("\t\t\t\t\t\t\t\twindow.URL.createObjectURL(sender.files[0]));\r\n");
      ...
      out.write("\t\t\t$(sender).prev().val(arr[arr.length - 1]);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//封面图片上传文件上传\r\n");
      out.write("\t\t$(\"#mainimgFile\").fileupload({\r\n");
      out.write("\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\tadd : function(e, data) {\r\n");
      out.write("\t\t\t\tdata.submit();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tdone : function(e, data) {//设置文件上传完毕事件的回调函数  \r\n");
      out.write("\t\t\t\t$(\"#pic_label1\").html(\"上传中。。。\");\r\n");
      out.write("\t\t\t\tsetTimeout(function() {\r\n");
      out.write("\t\t\t\t\tif (data.result.status == \"success\") {\r\n");
      out.write("\t\t\t\t\t\t$(\"#pic_label1\").attr(\"style\", \"color:green;\");\r\n");
      out.write("\t\t\t\t\t\t$(\"#pic_label1\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#pic_label1\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, 2000);\r\n");
      ...
      out.write("\t\t\t\t$(\"#pic_label1\").html(\"请求失败，请重试！\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//介绍图片1上传文件上传\r\n");
      out.write("\t\t$(\"#img1File\").fileupload({\r\n");
      out.write("\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\tadd : function(e, data) {\r\n");
      out.write("\t\t\t\tdata.submit();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tdone : function(e, data) {//设置文件上传完毕事件的回调函数  \r\n");
      out.write("\t\t\t\t$(\"#img1Info\").html(\"上传中。。。\");\r\n");
      out.write("\t\t\t\tsetTimeout(function() {\r\n");
      out.write("\t\t\t\t\tif (data.result.status == \"success\") {\r\n");
      out.write("\t\t\t\t\t\t$(\"#img1Info\").attr(\"style\", \"color:green;\");\r\n");
      out.write("\t\t\t\t\t\t$(\"#img1Info\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#img1Info\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, 2000);\r\n");
      ...
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tfail : function(e, data) {\r\n");
      out.write("\t\t\t\t$(\"#img1Info\").html(\"请求失败，请重试！\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//介绍图片2上传文件上传\r\n");
      out.write("\t\t$(\"#img2File\").fileupload({\r\n");
      out.write("\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\tadd : function(e, data) {\r\n");
      out.write("\t\t\t\tdata.submit();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tdone : function(e, data) {//设置文件上传完毕事件的回调函数  \r\n");
      out.write("\t\t\t\t$(\"#img2Info\").html(\"上传中。。。\");\r\n");
      out.write("\t\t\t\tsetTimeout(function() {\r\n");
      out.write("\t\t\t\t\tif (data.result.status == \"success\") {\r\n");
      out.write("\t\t\t\t\t\t$(\"#img2Info\").attr(\"style\", \"color:green;\");\r\n");
      out.write("\t\t\t\t\t\t$(\"#img2Info\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#img2Info\").html(data.result.message);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, 2000);\r\n");
      ...
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tfail : function(e, data) {\r\n");
      out.write("\t\t\t\t$(\"#img2Info\").html(\"请求失败，请重试！\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//已经存在的试读文件上传cloneid");
      ...
      out.write("\r\n");
      out.write("\t\t\tvar existCount =parseInt(");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:length(readFreeList)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0, false));
      out.write(");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfor(var i=1;i<=existCount;i++){\r\n");
      out.write("\t\t\t\t$(\"#cloneid\"+i).fileupload({\r\n");
      out.write("\t\t\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\t\t\tadd : function(e, data) {\r\n");
      out.write("\t\t\t\t\t\tdata.submit();\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\tdone : function(e, data) {//设置文件上传完毕事件的回调函数  \r\n");
      out.write("\t\t\t\t\t\tvar labelId=$(this).parent().next().attr(\"id\");\r\n");
      out.write("\t\t\t\t\t\t$(\"#\"+labelId).html(\"上传中。。。\");\r\n");
      out.write("\t\t\t\t\t\tsetTimeout(function() {\r\n");
      out.write("\t\t\t\t\t\t\tif (data.result.status == \"success\") {\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#\"+labelId).attr(\"style\", \"color:green;\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#\"+labelId).html(data.result.message);\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#\"+labelId).attr(\"style\", \"color:red;\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#\"+labelId).html(data.result.message);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}, 2000);\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\tfail : function(e, data) {\r\n");
      out.write("\t\t\t\t\t\t$(\"#\"+labelId).html(\"请求失败，请重试！\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//免费试读上传文件上传\r\n");
      out.write("\t\tfunction readfreeUpload(fileId,labelId) {\r\n");
      ...
      out.write("\t\t\tmessages : {\r\n");
      out.write("\t\t\t\tname : {\r\n");
      out.write("\t\t\t\t\trequired : \"书名不能为空\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tauthor : {\r\n");
      out.write("\t\t\t\t\trequired : \"作者不能为空\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tpublish : {\r\n");
      out.write("\t\t\t\t\trequired : \"出版社不能为空\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tprice : {\r\n");
      out.write("\t\t\t\t\trequired : \"价格不能为空\",\r\n");
      out.write("\t\t\t\t\tnumber : \"价格必须为数字\"\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tstock : {\r\n");
      out.write("\t\t\t\t\trequired : \"库存不能为空\",\r\n");
      out.write("\t\t\t\t\tnumber : \"库存必须为数字\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tintroduce : {\r\n");
      out.write("\t\t\t\t\trequired : \"图书简介不能为空\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tmainimgFile : {\r\n");
      out.write("\t\t\t\t\trequired : \"封面图片不能为空\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tdiscount : {\r\n");
      out.write("\t\t\t\t\tnumber : \"折扣必须为0~1之间的数字\"\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tfocusInvalid : true,\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//级联图书分类\r\n");
      out.write("\t\tfunction typeChange() {\r\n");
      out.write("\t\t\t//这里代码格式化之后的换行会导致出错，请注意\r\n");
      out.write("\t\t\tvar typenumber = $(\"#type\").val();\r\n");
      out.write("\t\t\t$(\"#subtype\").empty();\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_c_005furl_005f56(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /commons/top.jsp(10,14) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f56.setValue("/main/index");
  ...
  private boolean _jspx_meth_c_005furl_005f57(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f57.setValue("/assets/admin/layout2/img/logo.png");
  ...
  private boolean _jspx_meth_c_005furl_005f58(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f58.setValue("/assets/admin/layout2/img/avatar.png");
  ...
  private boolean _jspx_meth_c_005furl_005f59(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /commons/top.jsp(109,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f59.setValue("/manager/getManagerByPage");
  ...
  private boolean _jspx_meth_c_005furl_005f60(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /commons/top.jsp(114,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f60.setValue("/manager/passwordEdit.jsp");
  ...
  private boolean _jspx_meth_c_005furl_005f61(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /commons/top.jsp(118,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f61.setValue("/login/managerLogout");
  ...
  private boolean _jspx_meth_c_005furl_005f62(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /commons/top.jsp(134,19) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f62.setValue("/login/turnLogin");
  ...
  private boolean _jspx_meth_c_005furl_005f63(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f63.setValue("/order/getOrderByPage");
  ...
  private boolean _jspx_meth_c_005furl_005f64(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f64.setValue("/subType/SellectByParams");
  ...
  private boolean _jspx_meth_c_005furl_005f65(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f65.setValue("/book/getBookByPage");
  ...
  private boolean _jspx_meth_c_005furl_005f66(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f66.setValue("/main/count");
  ...
  private boolean _jspx_meth_c_005furl_005f67(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f67.setValue("/suggest/editSuggest");
  ...
  private boolean _jspx_meth_c_005furl_005f68(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f68.setValue("/manager/noticeAdd.jsp");
  ...
  private boolean _jspx_meth_c_005furl_005f69(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f69.setValue("/notice/getNoticeByPage");
  ...
  private boolean _jspx_meth_c_005furl_005f70(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f70.setValue("/manager/getManagerByPage");
  ...
  private boolean _jspx_meth_c_005furl_005f71(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_c_005furl_005f71.setValue("/manager/passwordEdit.jsp");
  ...
  private boolean _jspx_meth_c_005furl_005f72(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(57,24) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f72.setValue("/book/bookUpdate");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(116,17) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("type");
    // /book/edit.jsp(116,17) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/book/edit.jsp(116,17) '${typeList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${typeList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${type.typenumber}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /book/edit.jsp(118,19) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.type==type.typenumber}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(122,17) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("sub");
    // /book/edit.jsp(122,17) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/book/edit.jsp(122,17) '${subList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${subList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /book/edit.jsp(123,18) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.type==sub.typenumber}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_c_005fif_005f2(_jspx_th_c_005fif_005f1, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f1))
          return true;
        out.write('>');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sub.subtypedescn}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
        out.write("</option>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /book/edit.jsp(125,20) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${book.subtype==sub.id}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005furl_005f73(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(167,28) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f73.setValue("/upload/uploadImg");
  ...
  private boolean _jspx_meth_c_005furl_005f74(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(184,65) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f74.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("/upload/${book.mainimg }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005furl_005f75(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(215,28) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f75.setValue("/upload/uploadImg");
  ...
  private boolean _jspx_meth_c_005furl_005f76(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(232,65) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f76.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("/upload/${book.img1 }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005furl_005f77(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(264,28) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f77.setValue("/upload/uploadImg");
  ...
  private boolean _jspx_meth_c_005furl_005f78(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(286,65) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f78.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("/upload/${book.img2}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(319,38) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setVar("readFree");
    // /book/edit.jsp(319,38) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/book/edit.jsp(319,38) '${readFreeList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${readFreeList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /book/edit.jsp(319,38) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("                                      <tr class=\"album_div\" id=\"readFreeModel\">\r\n");
          out.write("                                      \t<input type=\"hidden\" id=\"readFreeId\" name=\"readFreeId\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.id }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("                                         <input type=\"hidden\" id=\"readFreeBookId\"  name=\"readFreeBookId\"  value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.bookId }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("                                           <input type=\"hidden\" id=\"readFreeNumber\" name=\"readFreeNumber\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.number }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>页码");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.number}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</th>\r\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" style=\"margin-top: -10px;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"clickUpload('cloneid");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index.count}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("')\" style=\"margin-left: -5px;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span> \r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"readFreeName\" name=\"readFreeName\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.src}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"cloneid");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index.count}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"readFree\" value=\"上传图片\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"set-up-button upload readFree\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; width: 200px;\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonchange=\"onUploadImgChange(this, 500, 'clonelogo");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index.count}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("')\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-url=\"");
          if (_jspx_meth_c_005furl_005f79(_jspx_th_c_005fforEach_005f2, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f2))
            return true;
          out.write("\" multiple>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label id=\"labelId");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index.count}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\" style=\"color: red\"></label>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style=\"margin-left: 50px;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn default btn-sm\" type=\"button\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"deleteReadFree(this,");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${readFree.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write(")\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-trash-o\"></i>删除\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix margin-top10\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img id=\"clonelogo");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index.count}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\" src='");
          if (_jspx_meth_c_005furl_005f80(_jspx_th_c_005fforEach_005f2, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f2))
            return true;
          out.write("' class=\"shlogo pull-left margin-right10\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 160px; height: 120px;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"pull-left shlogonotice\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"line-height: 22px;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t图 片建议尺寸：320像素x240像素<br> 仅支持 .jpg.jpeg.bmp.png格式<br>长\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f79(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  c:url
    ...
    _jspx_th_c_005furl_005f79.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f2);
    // /book/edit.jsp(339,27) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f79.setValue("/upload/uploadImg");
  ...
  private boolean _jspx_meth_c_005furl_005f80(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  c:url
    ...
    _jspx_th_c_005furl_005f80.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f2);
    // /book/edit.jsp(349,55) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f80.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("/upload/${readFree.src}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005furl_005f81(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(393,27) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f81.setValue("/upload/uploadImg");
  ...
  private boolean _jspx_meth_c_005furl_005f82(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(515,12) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f82.setValue("/book/readFreeDelete?id=\"+id+\"");
  ...
  private boolean _jspx_meth_c_005fforEach_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/edit.jsp(807,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f3.setVar("subtype");
    // /book/edit.jsp(807,3) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f3.setItems(new org.apache.jasper.el.JspValueExpression("/book/edit.jsp(807,3) '${subList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${subList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\tvar typenumber1 = ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${subtype.typenumber}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write(";\r\n");
          out.write("\t\t\tif (typenumber1 == typenumber) {\r\n");
          out.write("\t\t\t\t$(\"#subtype\")\r\n");
          out.write("\t\t\t\t\t\t.append(\r\n");
          out.write("\t\t\t\t\t\t\t\t'<option value=\"'+");
