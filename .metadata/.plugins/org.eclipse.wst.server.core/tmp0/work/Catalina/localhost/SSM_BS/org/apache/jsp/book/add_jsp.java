 ...
 * Generated at: 2016-04-16 16:06:25 UTC
...
public final class add_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"name\" name=\"name\" class=\"form-control input-large\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        \t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">作者：</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"author\" name=\"author\" class=\"form-control input-large\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("                                   <input type=\"text\" id=\"publish\" name=\"publish\" class=\"form-control input-large\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"price\" name=\"price\" class=\"form-control input-large\" value=\"\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"discount\" name=\"discount\" class=\"form-control input-large\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"color:blue;\">折<label style=\"color:grey;\">(必须是大于0小于等于1的数字)</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control input-large\" data-placeholder=\"全部\" id=\"type\" name=\"type\" onchange=\"typeChange()\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <select class=\"form-control input-large\" data-placeholder=\"全部\" id=\"subtype\" name=\"subtype\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"stock\" name=\"stock\" class=\"form-control input-large\" value=\"\">&nbsp;\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\" ><textarea rows=\"10\" cols=\"8\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"introduce\" name=\"introduce\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"uploadFile_1\" name=\"uploadFile_1\" placeholder=\"选择文件\" disabled=\"disabled\" class=\"form-control\" style=\"margin-top:-10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"   onclick=\"clickUpload('mainimg')\" style=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"mainimg\" name=\"mainimg\" value=\"上传图片\" class=\"set-up-button upload\" style=\"display:none; width:200px;\" onchange=\"onUploadImgChange(this,200,'mainImgShow')\" data-url=\"/msc/ajax/UploadPic/uploadResourceFTP.do?source=couponimages\" multiple=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:0; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img id=\"mainImgShow\" class=\"shlogo pull-left margin-right10\" src=\"\" style=\"width: 200px;  height: 160px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span name=\"previewInfo\"></span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"uploadFile_1\" name=\"uploadFile_1\" placeholder=\"选择文件\" disabled=\"disabled\" class=\"form-control\" style=\"margin-top:-10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"   onclick=\"clickUpload('img1')\" style=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"img1\" name=\"img1\" value=\"上传图片\" class=\"set-up-button upload\" style=\"display:none; width:200px;\" onchange=\"onUploadImgChange(this,200,'img1Show')\" data-url=\"/msc/ajax/UploadPic/uploadResourceFTP.do?source=couponimages\" multiple=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label id=\"pic_label1\" style=\"color:red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- <input type=\"hidden\" id=\"mallimage\" name=\"mallimage\" value=\"\"> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<table><tbody><tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:0; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img id=\"img1Show\" class=\"shlogo pull-left margin-right10\" src=\"\" style=\"width: 160px;  height: 120px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span name=\"previewInfo\"></span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>图片建议尺寸：320像素x240像素</p>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"uploadFile_1\" name=\"uploadFile_1\" placeholder=\"选择文件\" disabled=\"disabled\" class=\"form-control\" style=\"margin-top:-10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"   onclick=\"clickUpload('img2')\" style=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"img2\" name=\"img2\" value=\"上传图片\" class=\"set-up-button upload\" style=\"display:none; width:200px;\" onchange=\"onUploadImgChange(this,200,'img2Show')\" data-url=\"/msc/ajax/UploadPic/uploadResourceFTP.do?source=couponimages\" multiple=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label id=\"pic_label1\" style=\"color:red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style=\"margin-left:50px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn default btn-sm\" type=\"button\" onclick=\"deleteImg()\"><i class=\"fa fa-trash-o\"></i>删除</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<table><tbody><tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:0; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img id=\"img2Show\" class=\"shlogo pull-left margin-right10\" src=\"\" style=\"width: 160px;  height: 120px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span name=\"previewInfo\"></span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>图片建议尺寸：320像素x240像素</p>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"addImg()\" class=\"btn btn-primary btn-sm\" id=\"addalbums_btn\"><i class=\"fa fa-plus\"></i>添加图片</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"info notice\"><i class=\"fa fa-info-circle\"></i> 最多可以上传2张图片</span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><span class=\"info notice\" style=\"color:orange;\"><i class=\"fa fa-info-circle\"></i>试读图片默认页码默认从第一页开始，请按顺序上传！</span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr id=\"readFreeAddButton\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td class=\"lineheight34\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"addReadFree()\" class=\"btn btn-primary btn-sm\" id=\"addalbums_btn\"><i class=\"fa fa-plus\"></i>添加图片</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"info notice\" style=\"color:green\" id=\"notice\"><i class=\"fa fa-info-circle\"></i> <label id=\"freeNumber\">您还可以上传10张图片</label></span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 下面是试读模板 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr  class=\"album_div\" id=\"readFreeModel\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"uploadFile_1\" name=\"uploadFile_1\" placeholder=\"选择文件\" disabled=\"disabled\" class=\"form-control\" style=\"margin-top:-10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button class=\"fileUpload btn btn-primary\" type=\"button\"   onclick=\"clickUpload('img2')\" style=\"margin-left: -5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span>浏览</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"readFree\" name=\"readFree\" value=\"上传图片\" class=\"set-up-button upload\" style=\"display:none; width:200px;\" onchange=\"onUploadImgChange1(this,200,'')\" data-url=\"/msc/ajax/UploadPic/uploadResourceFTP.do?source=couponimages\" multiple=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label id=\"pic_label1\" style=\"color:red\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style=\"margin-left:50px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn default btn-sm\" type=\"button\" onclick=\"deleteReadFree(this)\"><i class=\"fa fa-trash-o\"></i>删除</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix margin-top10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"\" class=\"shlogo pull-left margin-right10\"  style=\"width: 160px;  height: 120px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"pull-left shlogonotice\" style=\"line-height:22px;\">图 片建议尺寸：320像素x240像素<br> 仅支持 .jpg.jpeg.bmp.png格式<br>长 方 形 照 片，大小不超过200KB</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn default\" onclick=\"javascript:history.go(-1)\"><i class=\"fa fa-angle-left\"></i>  返回</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"submit\"  id=\"submitBtn\" class=\"btn btn-primary\" ><i class=\"fa fa-save\"></i> 保存</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\txxx.find(\"input[type='file']\").attr(\"id\",\"cloneid\"+cloneCount);\r\n");
      out.write("\t\txxx.find(\"button.fileUpload\").attr(\"onclick\",\"clickUpload('cloneid\"+cloneCount+\"');\");\r\n");
      out.write("\t\t//initImageUpload(); \r\n");
      ...
      out.write("\tif (agent.indexOf(\"Firefox\") != -1 || agent.indexOf(\"Chrome\") != -1 || agent.indexOf(\"Mozilla\") != -1) {\r\n");
      out.write("\t\ttry {\r\n");
      out.write("\t\t\tif (preview == '') {\r\n");
      out.write("\t\t\t\t$(sender).parent(\"div\").next(\"img\").css({\"width\":\"220px\", \"height\":\"160px\"}).attr(\"src\", window.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$(\"#\"+preview).attr(\"src\", window.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t} catch (e) {\r\n");
      ...
      out.write("\t\ttry {\r\n");
      out.write("\t\t\tif (preview == '') {\r\n");
      out.write("\t\t\t\t$(sender).parent().parent().find(\"img\").css({\"width\":\"220px\", \"height\":\"160px\"}).attr(\"src\", window.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$(\"#\"+preview).attr(\"src\", window.URL.createObjectURL(sender.files[0]));\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t} catch (e) {\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f68(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/add.jsp(57,23) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/add.jsp(104,16) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("type");
    // /book/add.jsp(104,16) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/book/add.jsp(104,16) '${typeList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${typeList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /book/add.jsp(105,53) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /book/add.jsp(493,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("subtype");
    // /book/add.jsp(493,1) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/book/add.jsp(493,1) '${subList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${subList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
