 ...
 * Generated at: 2016-05-19 07:27:38 UTC
...
public final class typeAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<B>注意（由于大类号关系到顾客页面目录展示，请参照以下格式填写大类号）：</B><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>著作类  00</B>开头4位数字   例如0001<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>科技类  10</B>开头4位数字   例如1001<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>教育类  20</B>开头4位数字   例如2001<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>生活类  30</B>开头4位数字   例如3001<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>政治类  40</B>开头4位数字   例如4001<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<B>其他类   5000</B>之后的随便数字，不可重复！\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
