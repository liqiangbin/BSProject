 ...
 * Generated at: 2016-03-27 14:27:08 UTC
...
public final class noticeAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-home\"></i> <a href=\"/msc/main/index.do\">\r\n");
      out.write("\t\t\t\t\t\t\t\tIBOOk首页</a> <i class=\"fa fa-angle-right\"></i></li>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"javascript:void(0);\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"turnTo('/coupon/cashcoupon')\">公告管理</a> <i\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"fa fa-angle-right\"></i></li>\r\n");
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"javascript:void(0);\">发布公告</a></li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"caption-subject font-green-sharp bold\">发布公告</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"actions btn-set\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a class=\"btn btn-default btn-circle\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\thref=\"javascript:void(0);\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"turnTo('/coupon/cashcoupon')\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-angle-left\"></i> 返回<!-- 返 回--></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"portlet-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"table-responsive\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<form class=\"form-horizontal form-row-seperated form-inline\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\taction=\"");
      out.print(request.getContextPath() );
      out.write("/notice/insertNotice\" method=\"post\" id=\"createCouponForm\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tenctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <input type=\"hidden\" name=\"genType\" value=\"\"/> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<table class=\"table table-bordered table_sxcondition \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th style=\"min-width: 120px\">公告类型：<label\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: red;\">&nbsp;*&nbsp;</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"lineheight34\"><select id=\"type\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"type\" class=\"form-control input-large-plus\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"1\" selected=\"selected\">管理者公告</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"2\">优惠活动公告</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">公告关键字：<label style=\"color: red;\">&nbsp;*&nbsp;</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"title\" name=\"title\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control input-large-plus\" value=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tautofocus=\"\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>公告详细内容：<label style=\"color: red;\">&nbsp;*&nbsp;</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"lineheight34\"><textarea rows=\"10\" cols=\"8\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"\"></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th width=\"25%\">发布者签名：<label style=\"color: red;\">&nbsp;&nbsp;</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td width=\"75%\" class=\"lineheight34\"><label\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"authorNameShow\" style=\"color: grey;\">我是发布者</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"authorName\" value=\"我是发布者\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"javascript:history(-1);\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-angle-left\"></i> 后 退\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
