									...
									<div class="portlet-title">
                                       ...
                                       <i class="fa fa-plus"></i> 添加分类 <i class="fa fa-angle-down"></i>
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a href='<c:url value="/manager/noticeAdd.jsp"></c:url>'><i class="fa fa-file-o"></i> 添加大分类</a>
                                            </li>	
                                             <li>
                                                <a href='<c:url value="/manager/noticeAdd.jsp"></c:url>'><i class="fa fa-file-excel-o"></i> 添加细分类</a>
                                            </li>											
                                        </ul>
                                    </div>
										</div>
													...
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_products" aria-describedby="datatable_products_info" role="grid">
														...
														<a class="btn btn-circle btn-icon-only btn-default tooltips" href='<c:url value="/manager/showManager?id=${manager.id}"></c:url>' data-toggle="tooltip" data-placement="bottom" data-html="true" data-original-title="编辑" onclick="turnTo('/coupon/cashcoupon/edit/${item.id}')">
																<span class="glyphicon glyphicon-pencil"></span>
																	...
																	<a class="btn btn-circle btn-icon-only btn-default tooltips"  href='javascript:void(0);' onclick="javascript:showAlertModel('警告信息', '确认删除（删除后该类所包含的小类都将被删除）？','<c:url value="/notice/deleteById?id=${notice.id}"></c:url>');" data-toggle="tooltip" data-placement="bottom" data-html="true" data-original-title="添加子类">
