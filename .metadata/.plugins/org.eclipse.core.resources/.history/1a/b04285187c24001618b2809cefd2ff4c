...
<!-- cart -->
<script src='<c:url value="/customer/js/simpleCart.min.js"></c:url>'>
...
<link
	...
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href='<c:url value="/customer/css/jquery-ui.css"></c:url>'>
<!-- for bootstrap working -->
<script type="text/javascript" src='<c:url value="/customer/js/bootstrap-3.1.1.min.js"></c:url>'></script>
<link href='<c:url value="/customer/css/animate.min.css"></c:url>' rel="stylesheet">
<script src='<c:url value="/customer/js/wow.min.js"></c:url>'></script>
<script
